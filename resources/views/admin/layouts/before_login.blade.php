...
<head>
    ...
    <!-- Theme JS files -->
    <script src="{{ asset('vendor/global_assets') }}/js/plugins/forms/validation/validate.min.js"></script>
    ...
    <script src="{{ asset('vendor/global_assets') }}/js/demo_pages/login_validation.js"></script>
    <!-- /theme JS files -->
    @stack('css')
    @yield('css')
</head>
